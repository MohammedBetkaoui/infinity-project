...
try {
  ...
  await pause(500)
  assert(await evaluate('document.querySelector(".ax-process-copy h4").textContent === "Give the idea a shape."'))
  ...
  assert(await evaluate('document.querySelector(".ax-preparation-tracker [role=status]").textContent.startsWith("All items checked.")'))
