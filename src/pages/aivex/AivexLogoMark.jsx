import './aivex-logo-mark.css'

// Official AIVEX lockup artwork (five letter tiles fused into one graphic),
// traced 1:1 from the source vector — colours are baked into the mark itself.
export default function AivexLogoMark({ large = false, className = '', ...props }) {
  const marks = ['ax-logo-mark', large && 'ax-logo-mark-large', className].filter(Boolean).join(' ')
  return (
    <span className={marks} role="img" aria-label="AIVEX" {...props}>
      <svg viewBox="0 0 4032.01 826.2" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect fill="#fcfcfc" stroke="#000" strokeMiterlimit="10" strokeWidth="20" x="812.38" y="10" width="802.4" height="806.2" />
        <path fill="#930036" stroke="#000" strokeMiterlimit="10" strokeWidth="20" d="M3219.61,10H3999a23,23,0,0,1,23,23V793.2a23,23,0,0,1-23,23h-779.4a0,0,0,0,1,0,0V10A0,0,0,0,1,3219.61,10Z" />
        ...
        <path fill="#dc004d" stroke="#000" strokeMiterlimit="10" strokeWidth="20" d="M32.82,10H812.4a0,0,0,0,1,0,0V816.2a0,0,0,0,1,0,0H32.82A22.82,22.82,0,0,1,10,793.38V32.82A22.82,22.82,0,0,1,32.82,10Z" />
        <polygon fill="#fff" points="709.07 666.55 586.1 666.55 547.74 584.29 489.83 460.1 447.57 369.52 412.18 293.6 376.79 369.52 334.55 460.1 276.64 584.29 238.28 666.55 113.33 666.55 151.69 584.29 209.6 460.1 251.84 369.52 307.2 250.82 349.71 159.65 472.69 159.65 473.68 161.74 515.2 250.82 570.57 369.52 612.8 460.1 670.71 584.29 709.07 666.55" />
        <rect fill="#fff" stroke="#000" strokeMiterlimit="10" strokeWidth="20" x="2417.18" y="10" width="802.4" height="806.2" />
