...
const en = {
  ...
  fieldDocumentStatus: 'Document status',
  currentStatusTitle: 'Current file status',
  currentStatusAuto: 'Automatically synchronised',
  currentStatusHint: 'This status comes directly from the organisers’ administrative review.',
...
const fr = {
  ...
  fieldDocumentStatus: 'Statut du document',
  currentStatusTitle: 'État actuel du dossier',
  currentStatusAuto: 'Synchronisé automatiquement',
  currentStatusHint: 'Cet état provient directement du suivi administratif des organisateurs.',
...
const ar = {
  ...
  fieldDocumentStatus: 'حالة الوثيقة',
  currentStatusTitle: 'الحالة الحالية للملف',
  currentStatusAuto: 'تتم المزامنة تلقائياً',
  currentStatusHint: 'تأتي هذه الحالة مباشرة من المتابعة الإدارية للمنظمين.',
