    ...
    <section className="about-fields" aria-labelledby="about-fields-title">
      <div className="page-container">
        <div className="about-fields-heading">
          <div><h2 id="about-fields-title">Seven fields.<br />Find your way in.</h2></div>
          <p>You can arrive through code, design, communication, security or storytelling. The useful part begins when those perspectives meet.</p>
        </div>
