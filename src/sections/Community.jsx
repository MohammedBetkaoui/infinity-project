  ...
  return (
    <section id="communaute" className="community-section section-space">
      <div className="page-container">
        <div className="community-top"><h2>Different talents.<br />One place to meet.</h2><p>It is not a skill level, a language or a specialism that brings us together. It is the desire to understand things and build something with others.</p></div>
