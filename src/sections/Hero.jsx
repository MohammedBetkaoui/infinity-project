...
function TitleLine({ children }) {
  return <span className="hero-line"><span className="hero-word">{children}</span></span>
}
      ...
      <div className="page-container">
        ...
        <div className="hero-layout">
          <div className="hero-editorial">
            ...
            <h1><TitleLine>Repousse</TitleLine><TitleLine>tes limites.</TitleLine></h1>
        ...
        <div className="hero-footnote hero-detail">
          <p className="official-motto">No Limits For Infiniters<span>Une devise. Un état d’esprit.</span></p>
          <a href="#evenements" className="hero-event-link"><span className="event-mini-mark" aria-hidden="true">AI</span><span><strong>AIVEX</strong><small>Explorer l’intelligence artificielle, ensemble.</small></span><span className="event-link-action">Découvrir</span></a>
          <a href="https://www.instagram.com/club_.infinity/" target="_blank" rel="noreferrer" className="hero-social" aria-label="Infinity Club sur Instagram"><ArrowUpRight size={20} /></a>
        </div>
