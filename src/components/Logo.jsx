      ...
      <span className="brand-symbol">
        ...
        {scrollLinked && (
          <svg className="brand-journey" viewBox="0 0 56 44" fill="none" aria-hidden="true">
            <path className="brand-journey-ink" d="M28 2H50Q54 2 54 6V38Q54 42 50 42H6Q2 42 2 38V6Q2 2 6 2H28" stroke="currentColor" strokeWidth="1" strokeLinecap="round" />
            <g className="brand-journey-head"><circle r="1.7" fill="currentColor" /></g>
          </svg>
        )}
      </span>
      {!compact && (
