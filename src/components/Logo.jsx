...
export default function Logo({ compact = false, scrollLinked = false, className = '', onClick }) {
  return (
    ...
    >
      <span className="brand-symbol relative grid size-10 shrink-0 place-items-center overflow-hidden rounded-full bg-cream text-background shadow-[0_0_20px_rgba(183,243,151,.12)]">
        ...
        {scrollLinked && (
          <svg className="brand-journey" viewBox="0 0 580 480" fill="none" aria-hidden="true">
            <g transform="rotate(-23 290 240)">
              <path d={INFINITY_PATH} stroke="#788166" strokeWidth="18" opacity=".32" />
              <path className="brand-journey-ink" d={INFINITY_PATH} stroke="#436638" strokeWidth="22" strokeLinecap="round" />
              <g className="brand-journey-head"><circle r="29" fill="#172018" /></g>
            </g>
          </svg>
        )}
      </span>
